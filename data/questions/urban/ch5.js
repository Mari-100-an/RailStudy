...
var QUESTIONS_URBAN_CH5 = [
  ...
  // ==================== 5.1 전기동차 현황 ====================
  {
    id: 'license_vehicle_098',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 용어의 정의로 틀린 것은?',
    options: [
      '‘간선형 전기동차’란 도시와 도시 간의 운행을 목적으로 위생설비 등의 편의설비를 갖추고, 시속 200킬로미터 이하로 주행하는 전기동차를 말한다.',
      '‘광역철도’란 둘 이상의 시·도에 걸쳐 운행되는 도시철도 또는 철도로서, 대통령령으로 정하는 요건에 해당하는 도시철도 또는 철도를 말한다.',
      '‘경정비’란 차량의 주요장치 및 각 부의 기능상태 점검, 주요구성 부품 및 소모품의 교체 등 차량 주요 장치의 성능 확보를 위해 시행하는 유지 보수를 말한다.',
      '‘도시철도’란 도시교통의 원활한 소통을 위하여 도시교통권역에서 건설·운영하는 철도, 모노레일, 노면전차, 선형 유도전동기, 자기부상열차 등 궤도에 의한 교통 시설 및 교통수단을 말한다.'
    ],
    answer: 0,
    explanation: '표준교재에 따르면 ‘간선형 전기동차’란 도시와 도시 간의 운행을 목적으로 위생 설비 등의 편의 설비를 갖추고, 시속 150킬로미터 이하로 주행하는 전기동차를 말한다. (준고속형이 151~200km/h 미만)',
    source: '도시철도시스템 일반 제5장 [1]'
  },
  {
    id: 'license_vehicle_099',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 용어의 정의로 틀린 것은?',
    options: [
      '‘철도차량’이라 함은 선로를 운행할 목적으로 제작된 동력차·객차·화차 및 특수차를 말한다.',
      '‘축중’이란 수평 상태에서 1개 차축에 연결된 차륜에 가해지는 중량의 합을 말한다.',
      '‘경정비’란 차량전반에 대한 분해, 부품교체, 시험검사 및 측정, 시험운전 등 종합적인 성능을 확보하기 위해 시행하는 유지보수를 말한다.',
      '‘입창’이란 전동차가 중정비 또는 비정기 검사를 받기 위하여 주공장으로 들어가는 것을 말한다.'
    ],
    answer: 2,
    explanation: '보기 3번의 설명은 ‘중정비’에 대한 정의이다. 경정비는 차량의 주요 장치 및 각 부의 기능 상태 점검, 소모품 교체 등을 말한다.',
    source: '도시철도시스템 일반 제5장 [2], [3]'
  },
  {
    id: 'license_vehicle_100',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 중 전기동차 특징으로 틀린 것은?',
    options: [
      '높은 운영효율',
      '안전성과 신뢰성 확보',
      '동력집중방식 설계',
    ...
    answer: 2,
    explanation: '전기동차는 구동차(M차)를 차량 사이에 분산·연결하는 ‘동력 분산 방식’으로 설계되어 객실 공간 확보가 용이하고 축중 분배 및 고가속/고감속 운전이 가능하다.',
    source: '도시철도시스템 일반 제5장 [4]'
  },

  // ==================== 5.2 전기동차 일반 ====================
  {
    id: 'license_vehicle_101',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '견인전동기 회로에 저항기를 설치하고 순차적 또는 조합적 방식으로 전체 저항값을 변화시켜 견인전동기에 흐르는 전원을 제어하는 방식을 사용하는 전기동차는?',
    options: [
      '쵸퍼제어 전동차',
      '저항제어 전동차',
      'VVVF제어 전동차',
    ...
    answer: 1,
    explanation: '저항제어는 견인전동기 회로에 저항기를 설치하고 전체 저항값을 변화시켜 견인전동기에 흐르는 전원을 제어하는 방식이다.',
    source: '도시철도시스템 일반 제5장 [5]'
  },
  {
    id: 'license_vehicle_102',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 VVVF 인버터 제어차의 성능으로 틀린 것은?',
    options: [
      '연속정격 : 1,200kW',
      '상용제동 : 3.5km/h/sec',
      '가속도 : 3.0km/h/sec',
    ...
    answer: 0,
    explanation: '일반형 전기동차 제원표에 따르면 VVVF 인버터 제어차의 연속정격(2M 기준)은 1,600kW이다. (1,200kW는 쵸퍼 제어차)',
    source: '도시철도시스템 일반 제5장 [6]'
  },
  {
    id: 'license_vehicle_104',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 중량(Heavy)전철에 대한 설명으로 틀린 것은?',
    options: [
      '차체길이 : 17,500~19,500mm',
      '차체 폭 : 3,120mm 이상',
      '레일 상면 기준 지붕높이 : 3,600mm 이상',
      '승객정원 : 140~160명/칸'
    ],
    answer: 0,
    explanation: '중량(重輛) 전철인 대형 전동차는 차체 길이가 19,500mm 이상이다. (17,500~19,500mm는 중량(中輛) 전철인 중형 전동차)',
    source: '도시철도시스템 일반 제5장 [7]'
  },
  {
    id: 'license_vehicle_105',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '현재 우리나라에서 모노레일로 운영 중인 노선은?',
    options: [
      '부산김해경전철(주)',
      '인천국제공항~용유선',
      '대구도시철도공사 3호선',
    ...
    answer: 2,
    explanation: '대구도시철도 3호선은 모노레일(과좌식) 형식을 채택하여 운영 중이다. (부산김해: 철제차륜, 부산4호선: 고무차륜, 인천공항: 자기부상)',
    source: '도시철도시스템 일반 제5장 [8]'
  },
  {
    id: 'license_vehicle_106',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '전기동차 위치 칭호와 관련하여 차량의 앞쪽의 기준으로 틀린 것은?',
    options: [
      '간선형 전기동차 : 부수차 및 제1부수차는 화장실이 설치된 쪽',
      '일반형 전기동차 : 인버터 제어차에서 M차는 일반 배전반이 설치된 쪽',
      '준고속 전기동차 : M\', M차는 화장실이 설치된 쪽',
      '간선형 전기동차 : 제어차는 운전실이 설치된 쪽'
    ],
    answer: 2,
    explanation: '준고속형 전기동차(ITX-청춘)의 M\', M차는 팬터그래프가 설치된 반대쪽(하부 기기 기준 연동) 등을 앞쪽으로 보거나 별도 기준을 따르나, 일반적인 차량 칭호 기준에서 운전실이 있는 차량은 운전실 방향이 앞쪽이다.',
    source: '도시철도시스템 일반 제5장 [9]'
  },

  // ==================== 5.3 전기동차 구성 ====================
  {
    id: 'license_vehicle_107',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '전기동차 Unit 기본 구성으로 틀린 것은?',
    options: [
      '최초 기동에 필요한 에너지원 : 견인전동기(Motor)',
      '최초 기동에 필요한 압축공기 : 보조 공기압축기(ACM), 주공기 압축기(CM)',
      '객실등, 냉난방등 승객 서비스 : 보조전원장치(SIV)',
      '열차 운행에 필요한 전원 수전 장치 : 집전장치(Pantograph), 주변압기(MT)'
    ],
    answer: 0,
    explanation: '최초 기동에 필요한 에너지원은 축전지(Batt)이다. 견인전동기는 동력을 발생시키는 기기이다.',
    source: '도시철도시스템 일반 제5장 [10]'
  },
  {
    id: 'license_vehicle_110',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '일반형 전기동차와 간선형 전기동차의 일반적인 사양 한계에 대한 설명으로 틀린 것은?',
    options: [
      '견인 장치는 3M3T, 4M4T 및 5M5T 열차 편성에서도 견인 및 회생제동 특성은 동일하다.',
      '6칸 열차 편성 시 구동차 1칸, 8칸 또는 10칸 열차 편성 시 전동차 1유닛이 고장난 경우에도 최대 승객 하중 조건에서 고장 난 유닛을 개방한 상태로 35‰ 구배에서 기동이 가능하다.',
      '일반형 전기동차의 최고 운행속도는 80km/h이며, 일부 구간은 90km/h이다.',
      '간선형 전기동차의 감속도 : 상용 3.5km/h/s, 비상 4.5km/h/s'
    ],
    answer: 3,
    explanation: '간선형 전기동차의 감속도는 상용 3.0km/h/s, 비상 4.0km/h/s이다. (상용 3.5/비상 4.5는 일반형 VVVF 차량 기준)',
    source: '도시철도시스템 일반 제5장 [11]'
  },
  {
    id: 'license_vehicle_111',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '전기동차의 특고압기기 구성 및 기능에 대한 설명으로 틀린 것은?',
    options: [
      '교류과전류계전기 : 주변압기 1차 측에 과전류 발생 시 주차단기를 차단하고 주변압기를 보호한다.',
      '접지 브러시 : 귀환전류의 통로로서, 베어링의 전기적 부식을 방지하기 위하여 설치한다.',
      '주변압기 : 교류구간에서 전차선에 공급된 교류 25kV를 840V×2로 조정하여 주변환기 컨버터에 공급한다.',
      '주변환기(C/I) : 컨버터와 인버터를 합친 것으로 직류구간에서는 컨버터와 인버터 모두 구동되고, 교류구간에서는 교직절환기에 의해 인버터만 작동된다.'
    ],
    answer: 3,
    explanation: '주변환기(C/I)는 교류 구간에서는 컨버터와 인버터 모두 구동되고, 직류 구간에서는 교직 절환기에 의해 인버터만 작동된다. (설명이 반대로 됨)',
    source: '도시철도시스템 일반 제5장 [12]'
  },
  {
    id: 'license_vehicle_112',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 중 교·직류 전기동차에서 제일 중요한 기기는? (교류 구간 사고 차단 목적)',
    options: [
      '계기용변압기',
      '주차단기',
      '주퓨즈',
    ...
    answer: 1,
    explanation: '주 차단기(MCB)는 교·직류 전기동차에서 제일 중요한 기기이며, 교류 구간 운전 중 고장 발생 시 과전류를 신속하고 안전하게 차단할 목적으로 설치된다.',
    source: '도시철도시스템 일반 제5장 [13]'
  },
  {
    id: 'license_vehicle_113',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '다음 공기압축기에 대한 설명으로 틀린 것은?',
    options: [
      '동기구동 : 2개 이상의 공기압축기를 순차적으로 작동, 순차적으로 정지하여 부하편중을 방지한다.',
      '압축기 : 스크류 방식은 압축할 때 소음을 줄이기 위해 오일과 공기를 혼합하여 압축한다.',
      '공기건조기 : 마이크로 오일필터로 되어 있으며, 이곳을 통과하면 오일과 수분이 제거된다.',
      '안전밸브 : 제어회로의 이상으로 압축공기가 설정치 이상 되면 밸브가 열려서 압력을 분출함으로 기기를 보호한다.'
    ],
    answer: 0,
    explanation: '동기 구동은 2개 이상의 공기압축기를 동시 작동, 동시 정지하여 부하 편중을 방지하는 것이다.',
    source: '도시철도시스템 일반 제5장 [14]'
  },
  {
    id: 'license_vehicle_114',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '열차종합정보장치(TGIS)의 모드 중 서비스 기기 제어 기능으로 틀린 것은?',
    options: [
      '열차번호',
      '자동방송장치의 지점정보 지원',
      '냉난방 자동온도 제어, 화재경보 기능',
    ...
    answer: 2,
    explanation: '냉난방 자동 온도 제어 및 화재 경보 기능은 "기관사 지원 기능"에 해당한다.',
    source: '도시철도시스템 일반 제5장 [15]'
  },
  {
    id: 'license_vehicle_115',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '열차 비상제동이 체결되는 경우로 틀린 것은?',
    options: [
      '제동변 핸들 비상제동 위치 시',
      'ATS(자동열차정지장치) 또는 ATC(자동열차제어장치)의 비상제동 지령 시',
      '운전실의 비상제동 스위치 작동 시',
      '주공기압력이 높을 경우'
    ],
    answer: 3,
    explanation: '주 공기압력이 설정치 이하로 낮을 경우(부족할 경우)에 비상제동이 체결된다.',
    source: '도시철도시스템 일반 제5장 [16]'
  },
  {
    id: 'license_vehicle_116',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '제동체결방식에 대한 설명으로 틀린 것은?',
    options: [
      '정차제동 : 속도 검지에 의한 자동제동(과천선 전동차 포함)',
      '비상제동 : 지령선 무가압으로 전자밸브 무여자에 의한 순수 공기제동',
      '보안제동 : 지령선 가압으로 전자밸브 여자에 의한 순수 공기제동',
      '주차제동 : MR 압력 배기에 의한 스프링 작용방식 제동'
    ],
    answer: 0,
    explanation: '정차제동은 과천선 전동차에는 제외(미설치)되어 있다.',
    source: '도시철도시스템 일반 제5장 [17]'
  },

  // ==================== 5.4 유지 관리 ====================
  {
    id: 'license_vehicle_117',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '전기동차 검사의 종류 중 정기 검사에 대한 설명으로 틀린 것은?',
    options: [
      '일상검사 : 정하여진 검사 주기에 이르렀을 때 전동차 해당장치의 외관상태 및 동작상태를 확인하는 검사를 말한다(약호 : D).',
      '월상검사 : 기기 청소와 주요 소모품을 보충, 교환하고, 주요장치의 기능을 확인하는 검사를 말한다(약호 : 2M, 3M, 4M).',
      '중간검사 : 소정의 검사 주기가 도래하였을 때 주요 부품을 분해검사·정비 및 시험하는 검사를 말한다(약호 : 2Y, 3Y).',
      '성능검사 : 소정의 검사 주기가 도래하였을 때 영구결합 부분을 제외하고 해체가 필요한 부품을 분해검사·정비 및 시험하여 전동차 성능을 최적의 상태로 유지시키는 검사를 말한다(약호 : 4Y, 6Y).'
    ],
    answer: 3,
    explanation: '보기 4번의 설명은 ‘전반 검사’에 대한 정의이다. 성능 검사라는 명칭의 정기 검사는 규정되어 있지 않다.',
    source: '도시철도시스템 일반 제5장 [18]'
  },
  {
    id: 'license_vehicle_118',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '전기동차 검사의 종류 중 비정기 검사에 대한 설명으로 틀린 것은?',
    options: [
      '임시검사 : 전동차의 이상 상태 발생 시, 또는 이상징후가 감지될 때 이상 부위의 원상회복을 위하여 시행하는 검사를 말한다(약호 : C).',
      '특별검사 : 전동차 개조 또는 정비 등을 목적으로 특별히 계획에 의해 시행하는 검사를 말한다(약호 : S).',
      '차륜교환 검사 : 차륜 바깥지름이 교환한도에 도달하거나, 또는 차륜의 균열·파손 등으로 차륜을 교환하기 위하여 시행하는 검사를 말한다(약호 : NWC).',
      '인수검사 : 신규 제작하거나 주요 부위를 개조하여 도입된 전동차의 상태·기능 등을 확인하는 검사를 말한다(약호 : A).'
    ],
    answer: 0,
    explanation: '임시 검사의 약호는 ‘T’이다. (C는 Cleaning 또는 Check의 약어로 쓰일 수 있으나 표준교재상 임시검사는 T임)',
    source: '도시철도시스템 일반 제5장 [19]'
  },
  {
    id: 'license_vehicle_119',
    subject: 'vehicle',
    chapter: '차량일반',
    question: '한국철도공사 인버터 제어차 및 준고속형 전기동차의 최초 정비시기로 맞는 것은?',
    options: [
      '신규 제작 또는 구입하여 1,200㎞ 운행 시',
      '신규 제작 또는 구입하여 1,400㎞ 운행 시',
      '신규 제작 또는 구입하여 1,600㎞ 운행 시',
      '신규 제작 또는 구입하여 1,800㎞ 운행 시'
    ],
    answer: 2,
    explanation: '한국철도공사 기준 최초 정비는 신규 제작 또는 구입하여 1,600km 운행 시 시행한다.',
    source: '도시철도시스템 일반 제5장 [20]'
  }
];
